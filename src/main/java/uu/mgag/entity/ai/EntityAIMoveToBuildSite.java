...
public class EntityAIMoveToBuildSite extends EntityAIMoveToBlock
{
	...
	public int buildWid = 7;
	public int buildLen = 7;
	...
	protected boolean shouldMoveTo(World worldIn, BlockPos pos) {
		...
		for (int i = 0; i < buildWid; i++) for (int j = 0; j < buildLen; j++)
		{
			Vec3i offset1 = new Vec3i(i, 1, j);
			Vec3i offset2 = new Vec3i(i, 0, j);
			
			Block block1 = worldIn.getBlockState(pos.subtract(offset1)).getBlock();
			Block block2 = worldIn.getBlockState(pos.subtract(offset2)).getBlock();
